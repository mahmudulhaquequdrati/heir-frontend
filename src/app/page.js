  ...
  return (
    <main>
      <div className="bg-white flex flex-col">
        <div className="bg-[#213F61] flex flex-col-reverse sm:flex-row w-full min-h-[75vh] items-center px-8 md:px-16 lg:px-20 mx-auto pt-16 pb-64">
          <div className="w-full md:w-2/4">
            <p className="text-3xl md:text-4xl lg:text-5xl text-white leading-[4rem] font-clash font-medium">
              Find work or want
              <br />
          ...
          <div className="w-full md:w-[38%] mx-auto">
            <Image width="100" height="100" src={Hero} className="w-full" />
          </div>
        </div>
        ...
        {/* <div className="container mx-auto shadow-2xl bg-white self-stretch -translate-y-2/4 pl-28 pr-16 py-12 rounded-[500px] max-md:max-w-full max-md:mt-10 max-md:px-5">
          <div className="gap-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-center max-w-[1199px] mx-auto justify-items-center items-center">
            <div className="">
        ...
        <div className="container md:mx-auto shadow-2xl bg-white self-stretch -translate-y-2/4 pl-28 pr-16 py-12 rounded-[500px] max-md:max-w-full w-11/12 max-md:mt-10 max-md:px-5 mx-5">
          <div className="gap-5 grid grid-cols-1 sm:grid-cols-2 sm:px-8 md:grid-cols-3 lg:grid-cols-4 max-md:gap-0">
            <div className="flex flex-col items-stretch max-md:ml-0">
              <div className="flex items-start gap-5 my-auto mx-auto">
                <Image
                  loading="lazy"
                  width={100}
                  height={100}
