      ...
      <div className="pt-[35px] px-4 md:px-[30px] bg-[#F4F8FD] rounded-2xl mt-8">
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <div className="w-full sm:w-1/2 flex items-center gap-2 bg-[#F4F8FD] py-3 md:py-5 px-[18px] rounded-2xl">
                      <input type="radio" name="jobType" id="InPerson" />
                      <label htmlFor="InPerson">In person</label>
                    </div>
                    <div className="w-full sm:w-1/2 flex items-center gap-2 bg-[#F4F8FD] py-3 md:py-5 px-[18px] rounded-2xl">
                      <input type="radio" name="jobType" id="Online" />
        ...
        <div className="flex justify-center py-[60px]">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <button className="w-full sm:w-[220px] flex justify-center items-center gap-[10px] py-[21px] px-[20px] bg-[#E78C3B40] rounded-full">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
            ...
            <button className="w-full sm:w-[220px] flex justify-center items-center gap-[10px] bg-[#E78C3B] py-[21px] px-[20px] rounded-full">
