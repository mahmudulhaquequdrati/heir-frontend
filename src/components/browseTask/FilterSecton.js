  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        ...
        <p className="text-secondary">Clear all</p>
      </div>
      <hr className="my-5" />
      <div className="bg-[#F4F8FD] p-10 rounded-xl">
        ...
        <div>
          <div className="relative">
            ...
            <button
              type="submit"
              className="text-white absolute right-0 bottom-0 bg-secondary hover:bg-secondary font-medium rounded-lg text-sm px-5 py-[13px] "
            >
              Search
            </button>
          </div>
        ...
        <div className="flex flex-col items-start gap-[24px] p-[24px] relative bg-accent rounded-[24px] overflow-hidden">
          ...
          <div className="items-start gap-[16px] self-stretch w-full flex-[0_0_auto] flex relative cursor-pointer">
            <div
              ...
              className={
                toBeDone === "all"
                  ? "h-[56px] items-center justify-center  px-[24px] py-[10px] flex-1 grow bg-primary rounded-[12px] overflow-hidden flex relative"
                  : "h-[56px] flex items-center px-[24px] py-[10px]"
              }
            >
              <div
          ...
          <div className="items-start gap-[16px] self-stretch w-full flex-[0_0_auto] flex relative cursor-pointer">
            ...
            >
              <div
                ...
                } text-[18px] tracking-[0.20px] leading-[normal]`}
              >
                Available tasks
              </div>
            </div>
