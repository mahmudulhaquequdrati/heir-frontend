    ...
    <div>
        ...
        <div>
          <div className="relative">
            ...
            <input
              type="search"
              id="default-search"
              className="block w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 focus:border-gray-300 rounded-lg bg-white"
              placeholder="Search here..."
              required
            />
            <button
              type="submit"
              className="text-white absolute right-0 bottom-0 bg-secondery hover:bg-secondery font-medium rounded-lg text-sm px-5 py-[13px] "
            >
              Search
            </button>
          </div>
      ...
      <div className="bg-[#f4f8fd] rounded-xl mt-10">
        <div className="flex flex-col items-start gap-[24px] p-[24px] relative bg-accent rounded-[24px] overflow-hidden">
          ...
          <div className=" gap-[10px] self-stretch w-full flex-[0_0_auto] flex relative cursor-pointer">
            <div
              onClick={() => setToBeDone("all")}
              className={
                toBeDone === "all"
                  ? " items-center justify-center  px-[12px] py-[10px] flex-1 grow bg-primary rounded-[12px] overflow-hidden flex relative"
                  : " flex items-center px-[12px] py-[10px]"
              }
            >
              <div
                className={`relative w-fit [font-family:'Clash_Display-Semibold',Helvetica] font-normal ${
                  toBeDone === "all" ? "text-[#fdf3eb]" : "text-primary"
                } text-[16px] tracking-[0.20px] leading-[normal]`}
              >
                All
              </div>
            </div>
      ...
      <div className="bg-[#f4f8fd] rounded-xl mt-10">
        <div className="flex flex-col  gap-[24px] p-[24px] relative bg-accent rounded-[24px] overflow-hidden">
          <div className="items-center justify-between self-stretch w-full flex-[0_0_auto] flex relative">
            <div className="relative w-fit mt-[-1.00px] [font-family:'Clash_Display-Medium',Helvetica] font-medium text-primary text-[20px] tracking-[0] leading-[normal]">
              Task catagory
            </div>
          </div>
          <div className="items-center gap-[16px] self-stretch w-full flex-[0_0_auto] flex relative cursor-pointer">
            <div
      ...
      <div className="bg-[#f4f8fd] rounded-xl mt-10">
        <div className="flex flex-col items-center gap-[24px] p-[24px] relative bg-accent rounded-[24px] overflow-hidden">
          <div className="items-center justify-between self-stretch w-full flex-[0_0_auto] flex relative">
            <div className="relative w-fit mt-[-1.00px] [font-family:'Clash_Display-Medium',Helvetica] font-medium text-primary text-[20px] tracking-[0] leading-[normal]">
              Price Sorting
            </div>
          </div>
          <div className="items-center gap-[24px]  w-full flex-[0_0_auto] flex relative cursor-pointer">
            <div
      ...
      <div className="bg-[#f4f8fd] rounded-xl mt-10">
        <div className="flex flex-col items-start gap-[24px] p-[24px] relative bg-accent rounded-[24px] overflow-hidden">
          ...
          <div className="items-center gap-[16px]  w-full flex-[0_0_auto] flex relative cursor-pointer">
            <div
              ...
              <div
                className={`relative w-fit [font-family:'Clash_Display-Semibold',Helvetica] font-normal ${
                  datasorting.includes("lowest")
                    ? "text-[#fdf3eb]"
                    : "text-primary"
                } text-[20px] tracking-[0.20px] leading-[normal]`}
              >
                Latest
              </div>
            </div>
